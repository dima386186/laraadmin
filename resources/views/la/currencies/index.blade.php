...
@section("contentheader_description", "Currencies listing")
@section("section", "Currencies")
@section("sub_section", "Listing")
@section("htmlheader_title", "Currencies Listing")

@section("headerElems")
@la_access("Currencies", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add Currency</button>
@endla_access
@endsection
