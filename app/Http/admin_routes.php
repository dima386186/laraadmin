...
Route::group(['as' => $as, 'middleware' => ['auth', 'permission:ADMIN_PANEL']], function () {
	...
	/* ================== Histories ================== */
	Route::resource(config('laraadmin.adminRoute') . '/histories', 'LA\HistoriesController');
	Route::get(config('laraadmin.adminRoute') . '/history_dt_ajax', 'LA\HistoriesController@dtajax');
});
